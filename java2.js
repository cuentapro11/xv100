...
function initializeCountdown() {
    const targetDate = new Date('2026-12-31T17:00:00').getTime();
...
function openGiftLink() {
    window.open('https://www.amazon.com/', '_blank'); // TODO: reemplazar por el link real de tu lista de regalos de Amazon
}
